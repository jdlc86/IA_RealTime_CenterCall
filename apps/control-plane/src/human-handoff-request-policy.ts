...
/**
 * A human handoff is a destructive/terminal transition for Lucia. The model's
 * tool choice is therefore insufficient authority: the latest caller transcript
 * must itself contain explicit evidence that the caller wants a human.
 */
