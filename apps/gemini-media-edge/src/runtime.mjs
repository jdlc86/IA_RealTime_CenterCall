...
function playbackKind(value) { if (value == null || value === "NORMAL") return "NORMAL"; if (value === "GREETING" || value === "RECOVERY") return value; throw new Error("Gemini playback kind is unsupported"); }
