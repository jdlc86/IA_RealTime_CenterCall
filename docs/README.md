...
- [`architecture/GEMINI_PHASE3_PROGRESS.md`](./architecture/GEMINI_PHASE3_PROGRESS.md) — progreso de la arquitectura previa al Fast Path; histórico.
- [`architecture/ADR-002-GEMINI-EXTERNAL-MEDIA-PLANE.md`](./architecture/ADR-002-GEMINI-EXTERNAL-MEDIA-PLANE.md) — decisión inicial del media plane; partes superadas por ADR-004.
