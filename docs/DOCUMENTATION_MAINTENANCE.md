...
| Seguridad transversal | `../Security/IA_RealTime_CenterCall_Guia_Viva_Seguridad.docx` | cambia control, decisión, cobertura o backlog de seguridad |
| Procedimiento repetible | `runbooks/*.md` | cambia secuencia/comando/gate operativo |
| Evidencia/investigación extensa | issue, PR, ADR o historial Git | sólo si será útil posteriormente |
...
Los snapshots y planes superados no se mantienen indefinidamente en el árbol vigente. Se eliminan cuando una fuente canónica absorbe la información útil; Git conserva el historial. Los ADR aceptados se mantienen y declaran explícitamente su supersession.
...
No recuperar un documento `PHASE*_PROGRESS`, review o handoff antiguo desde Git como fuente primaria del estado.
...
2. los documentos históricos necesarios están marcados y los redundantes se han retirado;
